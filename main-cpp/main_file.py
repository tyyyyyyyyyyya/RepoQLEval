...
class LLMApiClient:
                ...
                for file in files:
                    if file.endswith(('.c','.cpp','.h')):
                        ...
                        try:
                            ...
                            #print({"path": file, "content": content})
    ...
    def call(self, prompt: str, model: str, use_history: bool = True, cpp_folder: Union[str, None] = None) -> dict:
        """调用大模型，支持系统提示词和对话历史以及所有c/cpp文件内容"""
